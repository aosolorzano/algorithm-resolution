...
import com.hiperium.algorithms.annotation.BiDimensionalStringListConverter;
...
class TournamentWinnerTest {
    ...
    void mustGetTournamentWinner(@BiDimensionalStringListConverter List<List<String>> competitions, @IntegerArrayConverter Integer[] results, String expectedWinner) {
